...
const translations = {
  en: {
    ...
    footer: {
      tagline: 'Business copyright protection & compliance',
      copyright: '© 2025 RightsGuard. All rights reserved.',
    },
  },
  cs: {
    nav: {
    ...
    footer: {
      tagline: 'Ochrana autorských práv a soulad pro firmy',
      copyright: '© 2025 RightsGuard. Všechna práva vyhrazena.',
    },
  },
};
